...
std::string XmlCommandGenerator::Disconnect() {
    return "<Command>\n<Operation>Disconnect</Operation>\n</Command>\n";
}

std::string XmlCommandGenerator::GetStatus() {
    return "<Command>\n<Operation>Get_Status</Operation>\n</Command>\n";
}

std::string XmlCommandGenerator::SetMode(int mode) {
    return "<Command>\n<Operation>Set_Mode</Operation>\n<Mode>" + std::to_string(mode) + "</Mode>\n</Command>\n";
}

std::string XmlCommandGenerator::SetTVG(int tvgA, int tvgB, int tvgC, int tvgL) {
    return "<Command>\n<Operation>Set_TVG</Operation>\n<TVG_A>" + std::to_string(tvgA) + "</TVG_A>\n<TVG_B>" + std::to_string(tvgB) + "</TVG_B>\n<TVG_C>" + std::to_string(tvgC) + "</TVG_C>\n<TVG_L>" + std::to_string(tvgL) + "</TVG_L>\n</Command>\n";
}

std::string XmlCommandGenerator::StopPing() {
    return "<Command>\n<Operation>Stop_Ping</Operation>\n</Command>\n";
}

std::string XmlCommandGenerator::StartPing(int mode) {
    if (mode != -1) {
...
std::string XmlCommandGenerator::StartRecord() {
    return "<Command>\n<Operation>Start_Record</Operation>\n</Command>\n";
}

std::string XmlCommandGenerator::StopRecord() {
    return "<Command>\n<Operation>Stop_Record</Operation>\n</Command>\n";
}

std::string XmlCommandGenerator::StartExport() {
    return "<Command>\n<Operation>Start_Export</Operation>\n</Command>\n";
}

std::string XmlCommandGenerator::StopExport() {
